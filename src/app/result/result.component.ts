...
//   }
  ...
  constructor(private serveyQuestionService:ServeyQuestionService,private activatedRoute:ActivatedRoute) { }
  ...
  ngOnInit(): void {
    ...
    this.serveyQuestionService.getAboutSurveyQuestionById(this.id).subscribe((surveyQuestion: any) => {



      console.log(surveyQuestion);
      this.serveyQuestionService.getSurveyResponseBySurveyId(this.id).subscribe((userResponseByQuestionId: any) => {
